...
execute if score #count monstercount matches 0 run function hunted:death/wincheck/hunter_win
execute if score #count huntercount matches 0 run function hunted:death/wincheck/monster_win